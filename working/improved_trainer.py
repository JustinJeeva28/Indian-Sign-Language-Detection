...
class ImprovedISLClassifier(nn.Module):
    ...
    def __init__(self, input_size: int = 126, hidden_sizes: List[int] = [512, 256, 128, 64], 
                 num_classes: int = 26, dropout_rate: float = 0.3, use_residual: bool = True):
...
class ImprovedISLTrainer:
    ...
    def load_config(self, config_path: Optional[str]) -> Dict:
        ...
        default_config = {
            'input_size': 126,
            'hidden_sizes': [512, 256, 128, 64],  # Deeper and wider for better capacity
            'dropout_rate': 0.3,
            'learning_rate': 0.001,
            'batch_size': 32,
            'epochs': 150,
    ...
    def initialize_model(self, num_classes: int):
        ...
        self.model = ImprovedISLClassifier(
            ...
            use_residual=True  # Enable residual connections for better learning
        ).to(self.device)
